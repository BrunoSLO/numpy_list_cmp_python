...
if __name__ == '__main__':
    ...
    numeros_potencia = list(map(potencia_2, numeros)) # Utilizando funcion que contiene el lambda
    print("potencias: ", numeros_potencia)
    
    numeros_inline = list(map(lambda x: x**2, numeros))  # Utilizando lambda inline
    print("potencias: ", numeros_inline)
